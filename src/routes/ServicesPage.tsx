  ...
  return (
    <section>
      <header className="section-header">
        <h2>Services</h2>
        <p>Perhaps we could exchange currency for the modification of the universe as you need. Such potential collaborations could include, but are not limited to things like:</p>
      </header>
      <ul>
